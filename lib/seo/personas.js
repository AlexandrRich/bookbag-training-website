export const personas = {
  ...
  "ai-sdr-vendors": {
    ...
    faqs: [
      ...
      { question: "How fast do messages clear the gate?", answer: "Safe messages clear instantly — no human needed. Only the ones the gate flags hit the review queue. After the first calibration cycle, the majority of messages pass review quickly, so the human review load is much lighter than people expect." },
    ],
  ...
  "sequencing-platforms": {
    ...
    faqs: [
      { question: "Does this slow down sequence delivery?", answer: "Not in any way your customers will notice. Safe messages clear instantly — zero human touch. Only the flagged ones hit the review queue. After the first calibration cycle, the majority of messages pass review quickly, so throughput barely changes while quality goes through the roof." },
  ...
  "cold-email-infrastructure": {
    ...
    faqs: [
      ...
      { question: "Can Bookbag handle high volume?", answer: "It's built for it. Safe messages are cleared for delivery instantly with zero human touch. Only flagged items hit the review queue. At enterprise tier, we gate millions of messages per month. The bottleneck is never the gate — it's the fraction that need human authority." },
  ...
  "finserv": {
    ...
    faqs: [
      ...
      { question: "How does this compare to existing compliance review costs?", answer: "FINRA standard review is $300 per filing, expedited is $600. The AI Production Gate costs a fraction of that per message — and it runs continuously, not as a spot-check. Safe messages are cleared for delivery. Your compliance team only touches the ones that actually need human authority." },
  ...
  "revops": {
    ...
    howItHelps: [
      ...
      { title: "Human authority where it matters, fast clearance where it doesn't", description: "Safe messages clear instantly. Human reviewers focus only on needs_fix and blocked items — the ones that actually need attention. You scale to 100K messages without scaling your review team proportionally." },
    ],
    bestFor: [
  ...
  "compliance-officer": {
    ...
    howItHelps: [
      ...
      { title: "Risk-based review that actually scales", description: "Safe messages are cleared for delivery — no human touch needed. Your compliance team focuses exclusively on needs_fix and blocked items: the messages that actually carry risk. You review 100% of output while only manually handling the ones that need attention." },
